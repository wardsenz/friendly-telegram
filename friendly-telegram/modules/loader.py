...
class LoaderMod(loader.Module):
    ...
    strings = {"name": "Загрузчик",
               ...
               "scam_module": "<b>Осторожно, в модуле найден SCAM-код для удаления аккаунта! Пожалуйста, отправьте репорт на автора или тому, кто Вам предоставил этот модуль! Чат: @ftgchatru</b>"}
