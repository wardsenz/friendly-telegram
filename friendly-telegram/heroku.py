...
def publish(clients, key, api_token=None, create_new=True, full_match=False):
    ...
    app.update_buildpacks(["https://github.com/heroku/heroku-buildpack-python",
                           "https://gitlab.com/friendly-telegram/heroku-buildpack", "https://github.com/heroku/heroku-buildpack-apt","https://github.com/jonathanong/heroku-buildpack-ffmpeg-latest.git"])
    repo = get_repo()
